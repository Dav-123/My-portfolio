...
const benefits = [
  ...
  { icon: TrendingUp, title: "Scale Together", desc: "First-mover advantage as Vora expands across Nigerian states." },
];
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base">
            Vora is actively seeking sponsors -- individuals, companies, and NGOs
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-start">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="rounded-2xl bg-card p-6 sm:p-8 border border-primary/20 shadow-sm">
            ...
            <div className="rounded-2xl bg-card p-6 sm:p-8 border border-border shadow-sm">
              <h4 className="font-display text-lg font-bold text-foreground mb-4">
                Sponsorship Tiers
              </h4>
              <div className="space-y-3">
                {tiers.map((tier) => (
                  <div key={tier.name} className="flex items-center justify-between p-4 rounded-xl bg-secondary/50 border border-border">
                    <div>
                      <p className="font-semibold text-foreground text-sm">{tier.name}</p>
                      <p className="text-muted-foreground text-xs">{tier.desc}</p>
                    </div>
                    <span className="text-primary font-bold text-sm whitespace-nowrap">{tier.amount}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          >
            {submitted ? (
              <div className="rounded-2xl bg-card p-8 sm:p-10 text-center border border-emerald-500/20 shadow-sm">
