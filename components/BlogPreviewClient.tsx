    ...
    <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6" ref={ref}>
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 sm:mb-14 gap-3 sm:gap-4"
        >
          <div>
            <p className="text-brand-500 font-semibold text-xs sm:text-sm tracking-widest uppercase mb-3 sm:mb-4">
              Latest Thinking
            </p>
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-black text-stone-900 dark:text-white">
              From the Blog
            </h2>
          </div>
          <Link
