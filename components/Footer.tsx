...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-stone-200 dark:border-stone-800 bg-stone-50 dark:bg-stone-950 px-6 py-16">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-2">
              {navLinks.map((link) => (
                <button
                  ...
                  className="text-left text-stone-500 dark:text-stone-500 hover:text-brand-500 text-sm transition-colors"
                >
                  {link.label}
                </button>
              ))}
        ...
        <div className="border-t border-stone-200 dark:border-stone-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-stone-400 dark:text-stone-600 text-sm">
            © {new Date().getFullYear()} David Briggs. All rights reserved.
          </p>
          <p className="text-stone-400 dark:text-stone-600 text-sm flex items-center gap-1">
