...
import { Github, Linkedin, Instagram, Facebook, ArrowDown, Shield, BookOpen, MessageCircle, Palette, Gamepad2 } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 sm:pt-28 pb-24 sm:pb-32 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto w-full flex flex-col items-center text-center">
        ...
        {/* Social icons - separated from writeups */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
